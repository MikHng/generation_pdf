            ...
            <div id="content">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <span class="mr-2 d-none d-lg-inline text-gray-600 small">Finance SOS</span>
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                       ...
                       <a href="http://127.0.0.1:8000/bilan"> <div class="alert alert-primary" role="alert">
                          Bilan
                        </div></a>
                      <a href="http://127.0.0.1:8000/etatfinance">  <div class="alert alert-secondary" role="alert">
                          Etat des Activites Financieres
                        </div></a>
                        <a href="http://127.0.0.1:8000/fonds"><div class="alert alert-success" role="alert">
                          Fonds restreints
                        </div></a>
                        <a href="http://127.0.0.1:8000/noteseaf"><div class="alert alert-danger" role="alert">
                          Notes EAF
                        </div></a>
                        <a href="http://127.0.0.1:8000/notesbilan"><div class="alert alert-warning" role="alert">
                          Notes Bilan
                        </div></a>
                        <a href="http://127.0.0.1:8000/etatflux"><div class="alert alert-info" role="alert">
